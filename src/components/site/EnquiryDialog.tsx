          ...
          <div className="p-8 text-center">
            ...
            <div className="mt-6 flex flex-col gap-2 sm:flex-row">
              ...
              <Button asChild variant="outline" size="lg" className="flex-1">
                <a href="https://wa.me/60123306815?text=Hi+I+would+like+to+learn+more+about+Brachtia+Homes+before+choosing+my+residence&utm_source=chatgpt.com" target="_blank" rel="noreferrer">
