...
export function rowToProperty(row: any): Property {
  return {
    ...
    iconOverrides: row.icon_overrides ?? {},
    ...
    paymentTerms: row.payment_terms ?? ["bimonthly", "quarterly", "full"],
    addons: row.addons ?? [],
...
export function propertyToRow(p: Property) {
  return {
    ...
    icon_overrides: p.iconOverrides ?? {},
    ...
    payment_terms: p.paymentTerms ?? ["bimonthly", "quarterly", "full"],
    addons: p.addons ?? [],
