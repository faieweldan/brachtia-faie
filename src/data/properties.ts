...
export type Property = {
  ...
  description: string[];
  heroImage: string;
  gallery: { src: string; caption: string; category?: GalleryCategory; featured?: boolean }[];
...
export const properties: Property[] = [
  {
    ...
    gallery: [
      ...
      { src: arcRoomCSingle, caption: "Room C Single (Exterior View)", category: "room" },
      { src: arcRoomCSingle2, caption: "Room C Single (Exterior View)", category: "room" },
      { src: arcRoomD, caption: "Room D Single (Corridor View)", category: "room" },
